...
export default function ConfirmCoffeeChatPage() {
  ...
  const fetchConfirmationData = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to load coffee chat details",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
  ...
  const handleConfirmSlot = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to confirm coffee chat",
        variant: "destructive",
      })
      setConfirming(false)
    }
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg bg-green-50 dark:bg-green-950 p-4 space-y-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-green-700 dark:text-green-300">Coffee Chat Details</h3>
              </div>
              <div>
            ...
            <div className="rounded-lg bg-secondary p-4">
              ...
              <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                ...
                <li>The recruiter will share location details closer to the date</li>
      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-xs text-muted-foreground text-center">
            By confirming, you agree to attend the coffee chat at the selected time.
