...
import { Briefcase, FileText, User, Home, Sparkles, LogOut, Bot, Github, Calendar } from "lucide-react"
...
export function StudentSidebar() {
  ...
  const navItems = [
    ...
    { href: "/student/interviews", icon: Calendar, label: "Interviews & Coffee Chats" },
